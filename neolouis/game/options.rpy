...
define config.window_show_transition = Dissolve(.4)
define config.window_hide_transition = Dissolve(.4)
...
define config.save_directory = "neolouis-1675702328"
